...
export const categories = [
    {
        ...
        subLessons: [
            ...
            { id: 't-borgo', title: 'ট, ঠ, ড, ঢ, ণ', sequence: generateBlockSequence([{key:'t',bn:'ট'}, {key:'T',bn:'ঠ'}, {key:'[',bn:'ড'}, {key:'{',bn:'ঢ'}, {key:'B',bn:'ণ'}], 20, 20) },
            ...
            { id: 'all-consonants', title: 'ক থেকে ঁ পর্যন্ত', sequence: generateBlockSequence([{key:'j',bn:'ক'}, {key:'J',bn:'খ'}, {key:'o',bn:'গ'}, {key:'O',bn:'ঘ'}, {key:'q',bn:'ঙ'}, {key:'y',bn:'চ'}, {key:'Y',bn:'ছ'}, {key:'u',bn:'জ'}, {key:'U',bn:'ঝ'}, {key:'I',bn:'ঞ'}, {key:'t',bn:'ট'}, {key:'T',bn:'ঠ'}, {key:'[',bn:'ড'}, {key:'{',bn:'ঢ'}, {key:'B',bn:'ণ'}, {key:'k',bn:'ত'}, {key:'K',bn:'থ'}, {key:'l',bn:'দ'}, {key:'L',bn:'ধ'}, {key:'b',bn:'ন'}, {key:'r',bn:'প'}, {key:'R',bn:'ফ'}, {key:'h',bn:'ব'}, {key:'H',bn:'ভ'}, {key:'m',bn:'ম'}, {key:'w',bn:'য'}, {key:'v',bn:'র'}, {key:'V',bn:'ল'}, {key:'M',bn:'শ'}, {key:'N',bn:'ষ'}, {key:'n',bn:'স'}, {key:'i',bn:'হ'}, {key:'p',bn:'ড়'}, {key:'P',bn:'ঢ়'}, {key:'W',bn:'য়'}, {key:'\\',bn:'ৎ'}, {key:'Q',bn:'ং'}, {key:':',bn:'ঃ'}, {key:'&',bn:'ঁ'}], 0, 20) }
        ]
    },
    {
        id: 'vowels',
