...
export const englishCategories = [
    ...
    },
    {
        ...
        subLessons: [
            ...
            { id: 'en-adv-4', title: 'Numeric Keypad', sequence: generateBlockSequence([{ keys: ["4"], char: '4' }, { keys: ["5"], char: '5' }, { keys: ["6"], char: '6' }, { keys: ["+"], char: '+' }, { keys: ["-"], char: '-' }], 15, 15, false) },
            { 
                id: 'en-adv-5', 
                title: 'Numeric Keypad Speed Drills', 
                screens: [
                    { title: "Drill 1", text: "943080604102357744" },
                    { title: "Drill 2", text: "423025625433698478" },
                    { title: "Drill 3", text: "248891310426531791" },
                    { title: "Drill 4", text: "382738155646803226" },
                    { title: "Drill 5", text: "571300322756543653" },
                    { title: "Drill 6", text: "668537016201704234" },
                    { title: "Drill 7", text: "163554544974611723" },
                    { title: "Drill 8", text: "654815640494812357" },
                    { title: "Drill 9", text: "296659439540319578" },
                    { title: "Drill 10", text: "705192148607360628" },
                    { title: "Drill 11", text: "744476555571750963" },
                    { title: "Drill 12", text: "168117445456866126" },
                    { title: "Drill 13", text: "327335061561043587" },
                    { title: "Drill 14", text: "359338948503722126" },
                    { title: "Drill 15", text: "156604449340642414" },
                    { title: "Drill 16", text: "887159646948244614" },
                    { title: "Drill 17", text: "412831772860527223" },
                    { title: "Drill 18", text: "178720093422361540" },
                    { title: "Drill 19", text: "957883717163426542" },
                    { title: "Drill 20", text: "250724980832360096" },
                    { title: "Drill 21", text: "055929855591527438" },
                    { title: "Drill 22", text: "778262571931301773" },
                    { title: "Drill 23", text: "124857026363295369" },
                    { title: "Drill 24", text: "321368210464189563" },
                    { title: "Drill 25", text: "775840509652111631" },
                    { title: "Drill 26", text: "931918853912688495" },
                    { title: "Drill 27", text: "862919395812127336" },
                    { title: "Drill 28", text: "815791943942799552" },
                    { title: "Drill 29", text: "221697482559704651" },
                    { title: "Drill 30", text: "974849958746542046" },
                    { title: "Drill 31", text: "121670835831464470" },
                    { title: "Drill 32", text: "351949854199650965" },
                    { title: "Drill 33", text: "762134968072031886" },
                    { title: "Drill 34", text: "257675578666358773" },
                    { title: "Drill 35", text: "037572743498184446" },
                    { title: "Drill 36", text: "412402527009508384" },
                    { title: "Drill 37", text: "405690468870499922" },
                    { title: "Drill 38", text: "855315548130839701" },
                    { title: "Drill 39", text: "874120959922077856" },
                    { title: "Drill 40", text: "184079369811493900" },
                    { title: "Drill 41", text: "724010694300745805" },
                    { title: "Drill 42", text: "123780860448884003" },
                    { title: "Drill 43", text: "868991425109554039" },
                    { title: "Drill 44", text: "179346797911881999" },
                    { title: "Drill 45", text: "886870291578775051" },
                    { title: "Drill 46", text: "033364899341045187" },
                    { title: "Drill 47", text: "330891306106328510" },
                    { title: "Drill 48", text: "748578936922305562" },
                    { title: "Drill 49", text: "059129027737953876" },
                    { title: "Drill 50", text: "482181112201310234" },
                    { title: "Drill 51", text: "658654807097056632" },
                    { title: "Drill 52", text: "816456639825067039" },
                    { title: "Drill 53", text: "544673220070391365" },
                    { title: "Drill 54", text: "596798850455864647" },
                    { title: "Drill 55", text: "784703333975610827" },
                    { title: "Drill 56", text: "324814793096311488" },
                    { title: "Drill 57", text: "897990082950064865" },
                    { title: "Drill 58", text: "151711428643391587" },
                    { title: "Drill 59", text: "222799783758664355" },
                    { title: "Drill 60", text: "605406817457393116" },
                    { title: "Drill 61", text: "264529441884694713" },
                    { title: "Drill 62", text: "902867266016644218" },
                    { title: "Drill 63", text: "205916574936576832" },
                    { title: "Drill 64", text: "620642667979008873" },
                    { title: "Drill 65", text: "097556967495834271" },
                    { title: "Drill 66", text: "721946956628133055" },
                    { title: "Drill 67", text: "066949455718518995" },
                    { title: "Drill 68", text: "879447186215439221" },
                    { title: "Drill 69", text: "064223869134818226" },
                    { title: "Drill 70", text: "739463069118356093" },
                    { title: "Drill 71", text: "516312006154627100" },
                    { title: "Drill 72", text: "145247303065089142" },
                    { title: "Drill 73", text: "052692469740027620" },
                    { title: "Drill 74", text: "887369413123193590" },
                    { title: "Drill 75", text: "034287155985511507" },
                    { title: "Drill 76", text: "596154471568900539" },
                    { title: "Drill 77", text: "118738252086594450" },
                    { title: "Drill 78", text: "569964668158822784" },
                    { title: "Drill 79", text: "433486554088896106" },
                    { title: "Drill 80", text: "008234261217288341" },
                    { title: "Drill 81", text: "537072427719702365" },
                    { title: "Drill 82", text: "143189781119509952" },
                    { title: "Drill 83", text: "719625109325881222" },
                    { title: "Drill 84", text: "176517992104130397" },
                    { title: "Drill 85", text: "652572576658559590" },
                    { title: "Drill 86", text: "016597646395037449" },
                    { title: "Drill 87", text: "578682702143012778" },
                    { title: "Drill 88", text: "075142040103025986" },
                    { title: "Drill 89", text: "949784460812926896" },
                    { title: "Drill 90", text: "381847810540346600" },
                    { title: "Drill 91", text: "314343767282510673" },
                    { title: "Drill 92", text: "799914791576381180" },
                    { title: "Drill 93", text: "614702221964327095" },
                    { title: "Drill 94", text: "551219938761783838" },
                    { title: "Drill 95", text: "600947841993815729" },
                    { title: "Drill 96", text: "839129135333695566" },
                    { title: "Drill 97", text: "868991425109554039" },
                    { title: "Drill 98", text: "179346797911881999" },
                    { title: "Drill 99", text: "886870291578775051" },
                    { title: "Drill 100", text: "033364899341045187" },
                    { title: "Drill 101", text: "330891306106328510" },
                    { title: "Drill 102", text: "748578936922305562" },
                    { title: "Drill 103", text: "059129027737953876" },
                    { title: "Drill 104", text: "482181112201310234" },
                    { title: "Drill 105", text: "658654807097056632" },
                    { title: "Drill 106", text: "816456639825067039" },
                    { title: "Drill 107", text: "544673220070391365" },
                    { title: "Drill 108", text: "596798850455864647" },
                    { title: "Drill 109", text: "784703333975610827" },
                    { title: "Drill 110", text: "066949455718518995" },
                    { title: "Drill 111", text: "879447186215439221" }
                ],
                get sequence() { return this.screens.map(s => s.text).join('').split('').map(c => ({ keys: [c], char: c })); }
            },
