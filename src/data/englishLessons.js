        ...
        subLessons: [
            ...
            { 
                ...
                screens: [
                    ...
                    { title: "Mixed Combo 1", text: "fed red die rid fed red" },
                    { title: "Mixed Combo 2", text: "ide rid ed die ide rid" },
            ...
            { 
                ...
                screens: [
                    ...
                    { title: "Mixed Combo 1", text: "can gin ice nag can gin" },
                    { title: "Mixed Combo 2", text: "cog run pen fin cog run" },
            ...
            { 
                ...
                screens: [
                    ...
                    { title: "Word Practice 1", text: "run fun red den rug cur" },
                    { title: "Word Practice 2", text: "ice kid fin pen engine" },
                    { title: "Short Sentences 1", text: "red rug fun run" },
                    { title: "Short Sentences 2", text: "fed the kid in red" },
                    { title: "Mixed Review Drill", text: "c g n d e i u r k j f" },
                    { title: "Speed Building", text: "ice fin pen engine run fun" },
                    { title: "Accuracy Challenge", text: "fed the kid in red run fun" },
                    { title: "Final Mastery Test", text: "red rug fun run fed the kid in red ice fin pen engine" }
                ],
                get sequence() { return this.screens.map(s => s.text).join('').split('').map(c => ({ keys: [c], char: c })); }
            },
            ...
            { 
                ...
                screens: [
                    ...
                    { title: "Short Patterns", text: "sit sit let let lit lit" },
                    { title: "Mixed Combo 1", text: "sit let lit stil sit let" },
                    { title: "Mixed Combo 2", text: "list salt tell sill list salt" },
            ...
            { 
                ...
                screens: [
                    ...
                    { title: "Short Patterns", text: "boa boa lab lab bag bag" },
                    { title: "Mixed Combo 1", text: "boa lab bag cob boa lab" },
                    { title: "Mixed Combo 2", text: "rob ban oak bob rob ban" },
            ...
            { 
                ...
                screens: [
                    ...
                    { title: "Short Patterns", text: "van van hem hem mug mug" },
                    { title: "Mixed Combo 1", text: "van hem mug ham van hem" },
                    { title: "Mixed Combo 2", text: "him vim Move jam him vim" },
