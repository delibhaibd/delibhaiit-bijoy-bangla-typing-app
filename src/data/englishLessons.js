    ...
    },
    {
        ...
        subLessons: [
            ...
            { 
                ...
                screens: [
                    { title: "Page 1: 4 & 5 Practice", text: "44 55 45 54 445 554 4545" },
                    { title: "Page 2: Home Row (4, 5, 6)", text: "456 654 4564 6545 4656" },
                    { title: "Page 3: Top Row (7, 8)", text: "77 88 78 87 778 887 7878" },
                    { title: "Page 4: Top Row (7, 8, 9)", text: "789 987 7897 9878 7989" },
                    { title: "Page 5: Bottom Row (1, 2)", text: "11 22 12 21 112 221 1212" },
                    { title: "Page 6: Bottom Row (1, 2, 3)", text: "123 321 1231 3212 1323" },
                    { title: "Page 7: Zero Key (0)", text: "00 000 40 50 60 70 80 90" },
                    { title: "Page 8: Decimal Key (.)", text: "0.5 1.2 3.4 5.6 7.8 9.0" },
                    { title: "Page 9: Addition Operator (+)", text: "4+5 5+6 7+8 8+9 1+2 2+3" },
                    { title: "Page 10: Subtraction Operator (-)", text: "9-4 8-5 7-6 6-2 5-1 3-2" },
                    { title: "Page 11: Plus & Minus Combo", text: "10+5-3 20-4+8 35+12-7" },
                    { title: "Page 12: Multiplication (*)", text: "2*3 4*5 6*7 8*9 3*4 5*6" },
                    { title: "Page 13: Division (/)", text: "8/2 9/3 12/4 15/5 20/4" },
                    { title: "Page 14: Multiply & Divide Combo", text: "12*4/2 25*2/5 36/6*3" },
                    { title: "Page 15: Low Numbers (0-4)", text: "0123 4321 0241 3102 4210" },
                    { title: "Page 16: High Numbers (5-9)", text: "5678 9876 5796 8657 9758" },
                    { title: "Page 17: Ascending & Descending", text: "0123456789 9876543210" },
                    { title: "Page 18: Vertical Column (7, 4, 1)", text: "741 147 7410 0147 7140" },
                    { title: "Page 19: Middle Column (8, 5, 2)", text: "852 258 8520 0258 8250" },
                    { title: "Page 20: Right Column (9, 6, 3)", text: "963 369 963. .369 936." },
                    { title: "Page 21: Mixed Operators 1", text: "14+25-6 8*5/2 99-33+11" },
                    { title: "Page 22: Mixed Operators 2", text: "450/10*2 75+25*4-50" },
                    { title: "Page 23: Currency & Decimals", text: "12.50 45.75 99.99 150.25" },
                    { title: "Page 24: Complex Formulas", text: "100+25.5*2-30/5 98.75" },
                    { title: "Page 25: Master Keypad Test", text: "0123456789+-*/. 100/4+75" }
                ],
                get sequence() { return this.screens.map(s => s.text).join('').split('').map(c => ({ keys: [c], char: c })); }
            },
            { 
                ...
                screens: [
                    { title: "Speed Drill 1: Addition", text: "125+350 420+180 750+250" },
                    { title: "Speed Drill 2: Subtraction", text: "980-320 650-240 890-450" },
                    { title: "Speed Drill 3: Multiplication", text: "25*4 50*12 15*15 75*8" },
                    { title: "Speed Drill 4: Division", text: "360/6 450/9 720/8 990/9" },
                    { title: "Speed Drill 5: Prices & Taxes", text: "19.99+2.50 49.95+5.00" },
                    { title: "Speed Drill 6: Discount Calcs", text: "150.00-15.50 89.00-9.25" },
                    { title: "Speed Drill 7: Invoice Totals", text: "250.00+450.50+125.25" },
                    { title: "Speed Drill 8: Quantity x Rate", text: "12*45.50 24*15.00 8*99.5" },
                    { title: "Speed Drill 9: Salary & Bonus", text: "25000+3500-1200 45000" },
                    { title: "Speed Drill 10: Percentage Calcs", text: "5000*0.15 12000*0.05" },
                    { title: "Speed Drill 11: Rapid 4-Digit Codes", text: "4589 1236 7845 9623 1578" },
                    { title: "Speed Drill 12: Rapid 6-Digit Codes", text: "789456 123789 456123 963852" },
                    { title: "Speed Drill 13: Phone & Account", text: "01712345678 01898765432" },
                    { title: "Speed Drill 14: Bank Transactions", text: "75000.00-12500.50+3000" },
                    { title: "Speed Drill 15: Point of Sale (POS)", text: "12.75+3.50+8.25-5.00" },
                    { title: "Speed Drill 16: Unit Conversion", text: "1000/100 2500/1000 45*100" },
                    { title: "Speed Drill 17: Decimal Series", text: "0.25 0.50 0.75 1.00 1.25" },
                    { title: "Speed Drill 18: Stepped Sums", text: "10+20+30+40+50+60+70+80" },
                    { title: "Speed Drill 19: High Speed Matrix", text: "741 852 963 159 357 753" },
                    { title: "Speed Drill 20: Alternating Signs", text: "100-20+30-40+50-60+70" },
                    { title: "Speed Drill 21: Daily Sales", text: "1450.50 2380.00 4890.75" },
                    { title: "Speed Drill 22: Ledger Posting", text: "50000-1500-2400-3600" },
                    { title: "Speed Drill 23: Mixed Decimal Math", text: "99.5*4.2/2+15.75-8.25" },
                    { title: "Speed Drill 24: Keypad Sprint", text: "1234567890 .+-*/ 987654" },
                    { title: "Speed Drill 25: Ultimate Numpad Test", text: "8520*1.5/2+450.75-125.00" }
                ],
                get sequence() { return this.screens.map(s => s.text).join('').split('').map(c => ({ keys: [c], char: c })); }
            },
